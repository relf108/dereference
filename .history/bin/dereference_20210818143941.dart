...
Future<void> main(List<String> args) async {
  ...
  String formatDate(){
    ...
    return '${date.day} ${date.month}, ${date}$'
  }

  var result =
      '$AU. $PY, "$T1", $T2, $JF, $BT, $SP, viewed ${DateTime.now().toLocal().toString()} ${DateTime.now().toLocal().hour.toString()}:${DateTime.now().toLocal().minute.toString()}, <$UR>.'
          .replaceAll('[', '')
          .replaceAll(']', '')
          .replaceAll(RegExp(' {2}'), ' ')
          .replaceAll(' ,', '');

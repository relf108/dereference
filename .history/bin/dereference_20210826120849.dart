...
Future<void> main(List<String> args) async {
  ...
  parseFile(refLines, refMap);
}

void parseFile({required refLines, required Map<dynamic, dynamic> refMap, bool inline}) {
  ...
  var result = '$AU. $PY, "$T1", $T2, $BT, $SP, viewed ${formatDate()}, <$UR>.'
      .replaceAll('[', '')
      .replaceAll(']', '')
      .replaceAll(RegExp(' {2}'), ' ')
      .replaceAll(' ,', '');
